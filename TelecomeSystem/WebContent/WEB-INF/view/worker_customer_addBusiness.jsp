...
// 	 		alert($("#manager").val());
			if($("#phone").val() == null || "" == $("#phone").val() || $("#name").val() == null || "" == $("#name").val() 
				...
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=addBusinessToReserve&phone="
					+$("#phone").val()+"&name="+$("#name").val()+"&customerType="+$("#customerType").val()
					+"&address="+$("#address").val()+"&manager="+$("#manager").val()+"&industry="+v;
			}
                    ...
                    <div>
                        <h4 class="example-title">客户资料添加</h4>
                				...
                				<div style="text-align:center; margin-top:200px; margin-bottom:200px">
                					<div >
                					<span style="font-size:17px; "></span>客户手机：<input id="phone" value="${businessCustomer.phone}">
                					</div>
                					<div style="marigin-top:20px">
                						<span style="font-size:17px"></span>客户姓名：<input id="name" value="${businessCustomer.name}">
                					</div>
                					<div>
                						<span style="font-size:17px"></span>客户类型：<input id="customerType" value="商客">
                					</div>
                					<div>
                					<span style="font-size:17px"></span>客户地址：<input id="address" value="${businessCustomer.address}">
                					</div>
                					<div>
                						<span style="font-size:17px"></span>客户经理：<input id="manager" value="${businessCustomer.manager}">
                					</div>
                					<div>
