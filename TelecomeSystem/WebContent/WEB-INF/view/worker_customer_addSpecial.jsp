...
// 	 		alert($("#manager").val());
			if($("#phone").val() == null || "" == $("#phone").val() || $("#name").val() == null || "" == $("#name").val() 
				...
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=addSpecialToReserve&phone="
					+$("#phone").val()+"&name="+$("#name").val()+"&customerType="+$("#customerType").val()
					+"&address="+$("#address").val()+"&manager="+$("#manager").val();
			}
                    ...
                    <div>
                        <h4 class="example-title">客户资料添加</h4>
                				...
                				<div style="text-align:center; margin-top:200px; margin-bottom:200px">
                					<div >
                					<span style="font-size:17px; "></span>客户手机：<input id="phone" value="${specialCustomer.phone}">
                					</div>
                					<div style="marigin-top:20px">
                						<span style="font-size:17px"></span>客户姓名：<input id="name" value="${specialCustomer.name}">
                					</div>
                					<div>
                						<span style="font-size:17px"></span>客户类型：<input id="customerType" value="专客">
                					</div>
                					<div>
                					<span style="font-size:17px"></span>客户地址：<input id="address" value="${specialCustomer.address}">
                					</div>
                					<div>
                						<span style="font-size:17px"></span>客户经理：<input id="manager" value="${specialCustomer.manager}">
                					</div>
                					<div>
