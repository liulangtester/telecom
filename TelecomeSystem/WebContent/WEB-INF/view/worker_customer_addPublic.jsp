...
// 	 		alert($("#manager").val());
					...
					|| $("#address").val() == null || "" == $("#address").val())
			{
				...
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=addPublicToReserve&phone="
                    ...
                    <div>
                        <h4 class="example-title">客户资料添加</h4>
                				...
                				<div style="text-align:center; margin-top:200px; margin-bottom:200px">
                					<div >
                					<span style="font-size:17px; "></span>客户手机：<input id="phone" value="${publicCustomer.phone}">
                					</div>
                					<div style="marigin-top:20px">
                						<span style="font-size:17px"></span>客户姓名：<input id="name" value="${publicCustomer.name}">
                					</div>
                					<div>
                						<span style="font-size:17px"></span>客户类型：<input id="customerType" value="公客">
                					</div>
                					<div>
                					<span style="font-size:17px"></span>客户地址：<input id="address" value="${publicCustomer.address}">
                					</div>
