...
// 			alert(v);
			if(v=="公客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=updateOrDeletePublic&type="+v;
			}else if(v=="商客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=updateOrDeleteBusiness&type="+v;
			}else if(v=="大客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=updateOrDeleteBig&type="+v;
			}else if(v=="专客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=updateOrDeleteSpecial&type="+v;
			}
		...
		<div id="page-wrapper" class="gray-bg" >
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
                    ...
                    <div>
                        <h4 class="example-title">客户资料修改及删除</h4>
                    </div>    
                    	
                				<div style="text-align:center; margin-top:200px; margin-bottom:200px">
                					
                					<span style="font-size:17px">客户类型：</span>
                    				<select style="width:200px;height:27px" >
  								  	...
  								  	<button onclick="submit()" style="margin-left:20px">提交</button><span style="color:red">${msg}</span>
                    			</div>
