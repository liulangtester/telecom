...
// 	 		alert($("#password").val());
			if($("#phone").val() == null || "" == $("#phone").val() 
				...
				window.location = "${pageContext.request.contextPath}/workerUserServlet?method=addToReserve&phone="
					+$("#phone").val()+"&address="+$("#address").val()+"&account="+$("#account").val()
					+"&password="+$("#password").val()+"&type="+v+"&remain_money="+$("#remain_money").val()
					+"&type="+v;
		...
		<div id="page-wrapper" class="gray-bg" >
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
                    ...
                    <div>
                        <h4 class="example-title">用户资料管理</h4>
                    </div>    
                    	
                				<div style="text-align:center; margin-top:200px; margin-bottom:200px">
                					<div >
                					<span style="font-size:17px; "></span>用户手机：<input id="phone" value="${user.user_phone}">
                					</div>
                					<div style="marigin-top:20px">
                						<span style="font-size:17px"></span>用户地址：<input id="address" value="${user.user_address}">
                					</div>
                					<div>
                						<span style="font-size:17px"></span>银行账号：<input id="account" value="${user.user_bank}">
                					</div>
                					<div>
                					<span style="font-size:17px"></span>用户密码：<input id="password" value="${user.user_password}">
                					</div>
                					<div>
                						<span style="font-size:17px"></span>账户余额：<input id="remain_money" value="${user.user_money}">
                					</div>
              
                					<div>
                						<span style="font-size:17px"></span>用户类型：
