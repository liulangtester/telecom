...
// 			alert(v);
			if(v=="公客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=queryPublic&type="+v;
			}else if(v=="商客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=queryBusiness&type="+v;
			}else if(v=="大客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=queryBig&type="+v;
			}else if(v=="专客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=querySpecial&type="+v;
			}
		...
		<div id="page-wrapper" class="gray-bg" >
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
                    ...
                    <div>
                        <h4 class="example-title">客户资料查询</h4>
                    </div>    
