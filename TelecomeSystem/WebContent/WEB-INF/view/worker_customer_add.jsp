...
// 			alert(v);
			if(v=="公客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=addPublic&type="+v;
			}else if(v=="商客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=addBusiness&type="+v;
			}else if(v=="大客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=addBig&type="+v;
			}else if(v=="专客"){
				window.location = "${pageContext.request.contextPath}/workerCustomerServlet?method=addSpecial&type="+v;
			}
