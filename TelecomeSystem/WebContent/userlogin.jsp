...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <h3>欢迎进入电信计费系统(用户登录页面)</h3>

            <form class="m-t"  action="${pageContext.request.contextPath}/userLoginServlet" method="post">
               ...
               <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary block full-width m-b">登 录</button><a href="workerlogin.jsp">工作人员登录入口</a>
